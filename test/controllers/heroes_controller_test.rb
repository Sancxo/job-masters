...
class HeroesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference("Hero.count") do
      post heroes_url, params: { hero: { health: @hero.health, name: @hero.name, strength: @hero.strength } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { health: @hero.health, name: @hero.name, strength: @hero.strength } }
